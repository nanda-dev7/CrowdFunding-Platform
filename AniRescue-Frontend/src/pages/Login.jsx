  ...
  return (
    <PageTransition className="mx-auto grid min-h-[calc(100vh-5rem)] max-w-7xl items-center gap-10 px-4 py-12 sm:px-6 lg:grid-cols-2 lg:px-8">
      <div>
        ...
        <h1 className="mt-3 text-5xl font-extrabold leading-tight text-ink">Continue funding urgent rescue care.</h1>
      ...
      <form onSubmit={submit} className="glass rounded-[2rem] border border-white p-6 shadow-soft">
        <div className="mb-6 flex h-14 w-14 items-center justify-center rounded-2xl bg-moss text-white">
          <HeartHandshake />
        </div>
        ...
        <p className="mt-5 text-sm text-bark/65">
          New to AniRescue? <Link className="font-bold text-moss" to="/register">Create an account</Link>
        </p>
      </form>
    </PageTransition>
  );
